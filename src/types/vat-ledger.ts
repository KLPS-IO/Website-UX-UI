...
export type VatLedgerRow={
  ...
  reimbursement_status:string|null;evidence_status:string;vat_review_status?:string|null;vat_period_id?:string|null;vat_period_start?:string|null;vat_period_end?:string|null;
