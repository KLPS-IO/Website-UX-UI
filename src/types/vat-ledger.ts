...
export type VatLedgerRow={
  ...
  reimbursement_status:string|null;evidence_status:string|null;vat_review_status?:string|null;vat_period_id?:string|null;stored_vat_period_id?:string|null;effective_vat_period_id?:string|null;vat_period_source?:"explicit"|"derived"|"none"|"conflict";effective_tax_point_date?:string|null;vat_period_start?:string|null;vat_period_end?:string|null;vat_period_date_conflict?:VatPeriodDateConflict|null;
