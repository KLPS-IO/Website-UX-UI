...
import type { DocumentAccessResponse, DocumentUploadResult, EvidenceDto, EvidenceEntityType, EvidenceFilters, EvidenceLinkDto, EvidenceMetadataInput } from "@/types/evidence";
...
export const evidenceRepository = {
  ...
  link: (id: string, entityType: EvidenceEntityType, entityId: string, relationship = "supports") => authenticatedApi<{ status: "success"; link: EvidenceLinkDto }>(`/api/finance/evidence/${id}/link`, { method: "POST", body: JSON.stringify({ entity_type: entityType, entity_id: entityId, relationship }) }),
