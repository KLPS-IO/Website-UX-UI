...
const companyRows = (company: CompanyRecord): [string, string][] => [
  ...
  ["Base currency", unknown(company.baseCurrency)],
  ["Financial year end", unknown(company.financialYearEnd)],
  ["First accounts period end", unknown(company.firstAccountsPeriodEnd)],
  ["First accounts filing deadline", unknown(company.firstAccountsFilingDeadline)],
  ...
  ["TRL", company.trl === null ? "Not confirmed" : String(company.trl)],
  ["CRL", unknown(company.crl)],
  ["Current raise target", company.currentRaiseAmount === null ? "Not confirmed" : money(company.currentRaiseAmount)],
