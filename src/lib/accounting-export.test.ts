...
test("MTD dialog selects a period and permits draft validation while generation stays gated",()=>{
  ...
  assert.match(component,/Before you can continue:/);assert.match(component,/Validate and generate/);
  assert.match(component,/disabled:bg-muted/);assert.match(component,/disabled:opacity-100/);
});
