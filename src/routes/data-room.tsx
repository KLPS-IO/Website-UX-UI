...
export const Route = createFileRoute("/data-room")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Fundraising deck, financial projections, cap table, market research and strategic documents for KPLS investors." },
    ],
  }),
  component: DataRoom,
});
          ...
          <aside className="lg:col-span-4 space-y-6">
            <div className="glass rounded-2xl p-6">
              ...
              <div className="mt-6">
                ...
                <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-secondary">
                  <div className="h-full w-[35%] rounded-full bg-accent shadow-[0_0_10px_var(--accent)]" />
                </div>
              </div>
            ...
            <div className="glass rounded-2xl p-6">
              ...
              <ul className="mt-4 space-y-1 text-sm">
                {["All Documents", "Pitch & Deck", "Financials", "IP Portfolio", "Market", "Legal"].map((c, i) => (
                  <li
                    key={c}
                  ...
                  >
                    <span>{c}</span>
                    <span className="font-mono text-[10px]">{i === 0 ? DOCS.length : "·"}</span>
                  </li>
                ))}
              </ul>
            </div>
