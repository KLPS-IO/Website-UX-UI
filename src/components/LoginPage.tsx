...
export function LoginPage({ onLogin, onBack, onShowSignUp }: LoginPageProps) {
      ...
      >
        <div className="space-y-6">
          <div className="text-center space-y-2">
            <h2 className="text-3xl text-purple-900">Welcome Back</h2>
          ...
          <div className="space-y-4">
            ...
            <Button
              onClick={onLogin}
              variant="outline"
              className="w-full h-14 border-2 border-green-200 hover:bg-green-50 rounded-xl flex items-center justify-center gap-3"
            >
              <Fingerprint className="w-5 h-5 text-green-600" />
              <span className="text-gray-700">Use Biometrics</span>
            </Button>
            ...
            <p className="text-center text-sm text-gray-600">
              ...
              <button type="button" onClick={onShowSignUp || onLogin} className="text-purple-600 hover:underline">
                Sign up
              </button>
            </p>
          </div>
